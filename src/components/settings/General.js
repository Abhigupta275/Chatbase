            ...
            <div class="p-5">
              <div class="pb-8">
                ...
                <div class="mt-1 flex items-center space-x-4">
                  <div class="font-semibold">XtmAh0NHl8LZEzu3GEhN9</div>
                  <button class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80 border border-zinc-200 bg-transparent shadow-sm hover:bg-zinc-100 hover:text-zinc-900 dark:border-zinc-800 dark:hover:bg-zinc-800 dark:hover:text-zinc-50 h-9 px-2 py-1">
                    <svg
              ...
              <div class="pb-8">
                ...
                <div class="mt-1 font-semibold">1,071</div>
              </div>
              <div>
                <label class="block text-sm font-medium text-zinc-700">
                  Name
