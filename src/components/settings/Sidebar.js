    ...
    <div>
      ...
      <section>
        <div class="mx-auto flex max-w-7xl flex-row justify-between px-4">
          <h4 class=" text-3xl font-bold">Settings</h4>
        </div>
                    ...
                    <ul role="list" class="flex flex-1 flex-col">
                      <li>
                        <ul role="list" class="space-y-1">
                            ...
                            <li>
                              ...
                              >
                                <svg
                                  ...
                                  stroke="currentColor"
                                  aria-hidden="true"
                                  class="text-violet-600 h-6 w-6 shrink-0"
                                >
                                  <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                          ...
                          {/* <li>
                            <Link
                              class="text-zinc-700 hover:bg-zinc-50 hover:text-violet-600 group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6"
