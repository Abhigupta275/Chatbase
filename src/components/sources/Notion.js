...
function Notion() {
  return (
    <div>
      <Sidebar lable={"Notion"}>
        <div className="p-5">
          <div className="flex flex-col items-center">
            <div className="py-12">
              <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80 shadow dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50/90 h-9 border-bg-grey-400 w-fit gap-3 bg-white p-6 font-semibold text-black hover:bg-zinc-100 hover:text-black">
                <svg
